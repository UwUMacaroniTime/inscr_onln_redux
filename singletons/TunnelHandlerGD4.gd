# (C) Tom Robinson (107zxz)

extends Node

signal failed(why: String)
signal success(code: String)
...
func _ready() -> void:
	...
	http_client.connect("request_completed", _rq_completed)


func establish_tunnel(code: String = "") -> void:
...
func establish_tunnel_between(addr_1: String, port_1: int, addr_2: String, port_2: int) -> void:
